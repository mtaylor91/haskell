...
{-|
Module : Kubernetes.OpenAPI.API.DiscoveryV1beta1
-}
...
module Kubernetes.OpenAPI.API.DiscoveryV1beta1 where
...
createNamespacedEndpointSlice 
  ...
  -> KubernetesRequest CreateNamespacedEndpointSlice contentType V1beta1EndpointSlice accept
createNamespacedEndpointSlice _  _ body (Namespace namespace) =
  _mkRequest "POST" ["/apis/discovery.k8s.io/v1beta1/namespaces/",toPath namespace,"/endpointslices"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data CreateNamespacedEndpointSlice 
instance HasBodyParam CreateNamespacedEndpointSlice V1beta1EndpointSlice 
...
deleteCollectionNamespacedEndpointSlice _  _ (Namespace namespace) =
  _mkRequest "DELETE" ["/apis/discovery.k8s.io/v1beta1/namespaces/",toPath namespace,"/endpointslices"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
deleteNamespacedEndpointSlice _  _ (Name name) (Namespace namespace) =
  _mkRequest "DELETE" ["/apis/discovery.k8s.io/v1beta1/namespaces/",toPath namespace,"/endpointslices/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
getAPIResources  _ =
  _mkRequest "GET" ["/apis/discovery.k8s.io/v1beta1/"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
listEndpointSliceForAllNamespaces  _ =
  _mkRequest "GET" ["/apis/discovery.k8s.io/v1beta1/endpointslices"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
listNamespacedEndpointSlice  _ (Namespace namespace) =
  _mkRequest "GET" ["/apis/discovery.k8s.io/v1beta1/namespaces/",toPath namespace,"/endpointslices"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
patchNamespacedEndpointSlice 
  ...
  -> Name -- ^ "name" -  name of the EndpointSlice
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest PatchNamespacedEndpointSlice contentType V1beta1EndpointSlice accept
patchNamespacedEndpointSlice _  _ body (Name name) (Namespace namespace) =
  _mkRequest "PATCH" ["/apis/discovery.k8s.io/v1beta1/namespaces/",toPath namespace,"/endpointslices/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body
...
readNamespacedEndpointSlice 
  ...
  -> Name -- ^ "name" -  name of the EndpointSlice
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest ReadNamespacedEndpointSlice MimeNoContent V1beta1EndpointSlice accept
readNamespacedEndpointSlice  _ (Name name) (Namespace namespace) =
  _mkRequest "GET" ["/apis/discovery.k8s.io/v1beta1/namespaces/",toPath namespace,"/endpointslices/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
replaceNamespacedEndpointSlice 
  ...
  -> Name -- ^ "name" -  name of the EndpointSlice
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest ReplaceNamespacedEndpointSlice contentType V1beta1EndpointSlice accept
replaceNamespacedEndpointSlice _  _ body (Name name) (Namespace namespace) =
  _mkRequest "PUT" ["/apis/discovery.k8s.io/v1beta1/namespaces/",toPath namespace,"/endpointslices/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data ReplaceNamespacedEndpointSlice 
instance HasBodyParam ReplaceNamespacedEndpointSlice V1beta1EndpointSlice 
