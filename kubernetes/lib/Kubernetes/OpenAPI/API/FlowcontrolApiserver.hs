...
{-|
Module : Kubernetes.OpenAPI.API.FlowcontrolApiserver
-}
...
module Kubernetes.OpenAPI.API.FlowcontrolApiserver where
...
getAPIGroup  _ =
  _mkRequest "GET" ["/apis/flowcontrol.apiserver.k8s.io/"]
