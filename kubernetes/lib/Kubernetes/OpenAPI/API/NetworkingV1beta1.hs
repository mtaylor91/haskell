...
createIngressClass 
  ...
  -> KubernetesRequest CreateIngressClass contentType V1beta1IngressClass accept
createIngressClass _  _ body =
  _mkRequest "POST" ["/apis/networking.k8s.io/v1beta1/ingressclasses"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data CreateIngressClass 
instance HasBodyParam CreateIngressClass V1beta1IngressClass 
...
deleteCollectionIngressClass _  _ =
  _mkRequest "DELETE" ["/apis/networking.k8s.io/v1beta1/ingressclasses"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
deleteIngressClass _  _ (Name name) =
  _mkRequest "DELETE" ["/apis/networking.k8s.io/v1beta1/ingressclasses/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
listIngressClass  _ =
  _mkRequest "GET" ["/apis/networking.k8s.io/v1beta1/ingressclasses"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
patchIngressClass 
  ...
  -> Body -- ^ "body"
  -> Name -- ^ "name" -  name of the IngressClass
  -> KubernetesRequest PatchIngressClass contentType V1beta1IngressClass accept
patchIngressClass _  _ body (Name name) =
  _mkRequest "PATCH" ["/apis/networking.k8s.io/v1beta1/ingressclasses/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body
...
readIngressClass  _ (Name name) =
  _mkRequest "GET" ["/apis/networking.k8s.io/v1beta1/ingressclasses/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
instance HasOptionalParam ReadIngressClass Exact where
...
instance HasOptionalParam ReadIngressClass Export where
...
replaceIngressClass 
  ...
  -> V1beta1IngressClass -- ^ "body"
  -> Name -- ^ "name" -  name of the IngressClass
  -> KubernetesRequest ReplaceIngressClass contentType V1beta1IngressClass accept
replaceIngressClass _  _ body (Name name) =
  _mkRequest "PUT" ["/apis/networking.k8s.io/v1beta1/ingressclasses/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data ReplaceIngressClass 
instance HasBodyParam ReplaceIngressClass V1beta1IngressClass 
