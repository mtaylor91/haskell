...
{-|
Module : Kubernetes.OpenAPI.API.NodeV1beta1
-}
...
module Kubernetes.OpenAPI.API.NodeV1beta1 where
...
createRuntimeClass _  _ body =
  _mkRequest "POST" ["/apis/node.k8s.io/v1beta1/runtimeclasses"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data CreateRuntimeClass 
instance HasBodyParam CreateRuntimeClass V1beta1RuntimeClass 
...
deleteCollectionRuntimeClass _  _ =
  _mkRequest "DELETE" ["/apis/node.k8s.io/v1beta1/runtimeclasses"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
deleteRuntimeClass _  _ (Name name) =
  _mkRequest "DELETE" ["/apis/node.k8s.io/v1beta1/runtimeclasses/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
getAPIResources  _ =
  _mkRequest "GET" ["/apis/node.k8s.io/v1beta1/"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
listRuntimeClass  _ =
  _mkRequest "GET" ["/apis/node.k8s.io/v1beta1/runtimeclasses"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
patchRuntimeClass _  _ body (Name name) =
  _mkRequest "PATCH" ["/apis/node.k8s.io/v1beta1/runtimeclasses/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body
...
readRuntimeClass  _ (Name name) =
  _mkRequest "GET" ["/apis/node.k8s.io/v1beta1/runtimeclasses/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
replaceRuntimeClass _  _ body (Name name) =
  _mkRequest "PUT" ["/apis/node.k8s.io/v1beta1/runtimeclasses/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data ReplaceRuntimeClass 
instance HasBodyParam ReplaceRuntimeClass V1beta1RuntimeClass 
