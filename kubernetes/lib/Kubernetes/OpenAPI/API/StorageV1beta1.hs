...
deleteCSIDriver 
  ...
  -> KubernetesRequest DeleteCSIDriver contentType V1beta1CSIDriver accept
...
deleteCSINode 
  ...
  -> KubernetesRequest DeleteCSINode contentType V1beta1CSINode accept
...
deleteStorageClass 
  ...
  -> KubernetesRequest DeleteStorageClass contentType V1beta1StorageClass accept
...
deleteVolumeAttachment 
  ...
  -> KubernetesRequest DeleteVolumeAttachment contentType V1beta1VolumeAttachment accept
