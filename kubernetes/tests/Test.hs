...
main =
  hspec $ modifyMaxSize (const 10) $ do
    describe "JSON instances" $ do
      ...
      propMimeEq MimeJSON (Proxy :: Proxy AdmissionregistrationV1beta1WebhookClientConfig)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy ApiextensionsV1beta1ServiceReference)
      propMimeEq MimeJSON (Proxy :: Proxy ApiextensionsV1beta1WebhookClientConfig)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy ExtensionsV1beta1HTTPIngressPath)
      propMimeEq MimeJSON (Proxy :: Proxy ExtensionsV1beta1HTTPIngressRuleValue)
      propMimeEq MimeJSON (Proxy :: Proxy ExtensionsV1beta1Ingress)
      propMimeEq MimeJSON (Proxy :: Proxy ExtensionsV1beta1IngressBackend)
      propMimeEq MimeJSON (Proxy :: Proxy ExtensionsV1beta1IngressList)
      propMimeEq MimeJSON (Proxy :: Proxy ExtensionsV1beta1IngressRule)
      propMimeEq MimeJSON (Proxy :: Proxy ExtensionsV1beta1IngressSpec)
      propMimeEq MimeJSON (Proxy :: Proxy ExtensionsV1beta1IngressStatus)
      propMimeEq MimeJSON (Proxy :: Proxy ExtensionsV1beta1IngressTLS)
      propMimeEq MimeJSON (Proxy :: Proxy FlowcontrolV1alpha1Subject)
      propMimeEq MimeJSON (Proxy :: Proxy NetworkingV1beta1HTTPIngressPath)
      propMimeEq MimeJSON (Proxy :: Proxy NetworkingV1beta1HTTPIngressRuleValue)
      propMimeEq MimeJSON (Proxy :: Proxy NetworkingV1beta1Ingress)
      propMimeEq MimeJSON (Proxy :: Proxy NetworkingV1beta1IngressBackend)
      propMimeEq MimeJSON (Proxy :: Proxy NetworkingV1beta1IngressList)
      propMimeEq MimeJSON (Proxy :: Proxy NetworkingV1beta1IngressRule)
      propMimeEq MimeJSON (Proxy :: Proxy NetworkingV1beta1IngressSpec)
      propMimeEq MimeJSON (Proxy :: Proxy NetworkingV1beta1IngressStatus)
      propMimeEq MimeJSON (Proxy :: Proxy NetworkingV1beta1IngressTLS)
      propMimeEq MimeJSON (Proxy :: Proxy RbacV1alpha1Subject)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1TokenRequest)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1AuditSink)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1AuditSinkList)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1AuditSinkSpec)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1FlowDistinguisherMethod)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1FlowSchema)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1FlowSchemaCondition)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1FlowSchemaList)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1FlowSchemaSpec)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1FlowSchemaStatus)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1GroupSubject)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1LimitResponse)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1LimitedPriorityLevelConfiguration)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1NonResourcePolicyRule)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1Policy)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1PolicyRule)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1PolicyRulesWithSubjects)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1PriorityClass)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1PriorityClassList)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1PriorityLevelConfiguration)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1PriorityLevelConfigurationCondition)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1PriorityLevelConfigurationList)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1PriorityLevelConfigurationReference)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1PriorityLevelConfigurationSpec)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1PriorityLevelConfigurationStatus)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1QueuingConfiguration)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1ResourcePolicyRule)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1ServiceAccountSubject)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1ServiceReference)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1UserSubject)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1Webhook)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1WebhookClientConfig)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1WebhookThrottleConfig)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1CSIDriver)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1CSIDriverList)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1CSIDriverSpec)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1CSINode)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1CSINodeDriver)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1CSINodeList)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1CSINodeSpec)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1CustomResourceColumnDefinition)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1CustomResourceConversion)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1CustomResourceDefinitionVersion)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1CustomResourceSubresourceScale)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1CustomResourceSubresources)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1IngressClass)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1IngressClassList)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1IngressClassSpec)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1JSONSchemaProps)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1JobTemplateSpec)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1Lease)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1LeaseList)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1LeaseSpec)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1LocalSubjectAccessReview)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1MutatingWebhook)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1PriorityClass)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1PriorityClassList)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1ValidatingWebhook)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1VolumeAttachment)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1VolumeAttachmentList)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1VolumeAttachmentSource)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1VolumeAttachmentSpec)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1VolumeAttachmentStatus)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1VolumeError)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1VolumeNodeResources)
